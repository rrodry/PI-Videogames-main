    ...
    if (generosGet && platformGet) {
        ...
        return (
            <div className="containerDiv">
                <form onSubmit={e => handleSubmitCreate(e, setInputSend, inputSend, dispatch)} >
                    <div className="divCreate">
                        ...
                        <div className="dvInputCreate">
                            ...
                            <input className="inputCreate" placeholder="Launch Date" value={inputSend.launchDate} name="launchDate" onChange={e => handleInputAdd(e, setInputSend, inputSend, setErrors)} />
                        </div>
                        <div className="dvInputCreate">
                        ...
                        <div className="dvInputCreate">
                            ...
                            <input className="inputCreate" type="file" placeholder="Image" value={inputSend.image} name="image" 
                            onChange={e => handleInputAddImage(e, setInputSend, inputSend, setErrors)} />
                        </div>
                    </div> 
                    <div className="divCreate">
                        <div className="divSelect">
                            <select className="selectCreate" onChange={e => handleAddGenders(e, setInputSend, inputSend)}>
                                <option defaultValue>Genders</option>
                                {generosGet.map(e => <option value={e.gender}>{e.gender}</option>)}
                            </select>
                        ...
                        <div>
                            <label className="labelCreate"> {inputSend.genders.map(e => { return (<label>{e} </label>) })} </label>
                        </div>
                    </div>
                <div>
